        ...
        try {
            ...
            if ($user) {
                ...
                try {
                    ...
                    $mail->SMTPAuth   = true;
                    $mail->Username   = 'efeapoki2020@gmail.com'; // Replace with your SMTP username
                    $mail->Password   = 'bqvzqdkksvalkdnk'; // Replace with your SMTP password
                    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS; // Enable TLS encryption, `ssl` also accepted
                    $mail->Port       = 587; // You may use 465 instead for 'ssl'

                    //Recipients
                    $mail->setFrom('serenity@example.com', 'efe'); // Replace with your name and email address
